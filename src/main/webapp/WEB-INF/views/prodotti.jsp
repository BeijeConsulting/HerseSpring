...
<c:forEach var="item" items="${lista}">
 ...
 <c:when test="${contains}">
        ...
        <form action="../carrello/edit" method="post">
         ...
         aggiungine altri:
        <input type="number" name="how_many" min="1" max="${p.quantity}" placeholder="nuova quantità" value="1">
        <input type="submit" value="Aggiungine altri">
        </form>
        
        <form action="../carrello/remove_product" method="post">
